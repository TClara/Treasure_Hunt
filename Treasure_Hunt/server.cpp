...
#ifdef LOCAL_GAME
using GameIO = duels::LocalGame<initMsg, inputMsg, feedbackMsg, displayMsg, 500, 20>;
#else
using GameIO = duels::Server<initMsg, inputMsg, feedbackMsg, displayMsg, 500, 20>;
#endif
...
int main(int argc, char** argv)
{
  ...
  while(true)
  {
    ...
    for (int i=0;i<1001;i++){
        if ((i<G.b1.Sonar_coordinates.xs.size()) || (i<G.b2.Sonar_coordinates.xs.size()))
        {
